...
static void set_server_version(void)
{
  ...
  /*BEGIN guosong 2016-10-21 MODIFCATION*/
  /*Reason for Modifcation:*/
  /*This section adds my revision note to the MySQL test*/
  strmov(end, "-Guosong Modification");
  /*END guosong 2016-10-21 MODIFCATION*/
